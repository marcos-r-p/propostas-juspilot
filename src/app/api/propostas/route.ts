...
export async function POST(request: NextRequest) {
  ...
  const propostaData = {
    ...
    consultor_nome: formData.consultor_nome || null,
    consultor_cargo: formData.consultor_cargo || null,
    consultor_whatsapp: formData.consultor_whatsapp || null,
    consultor_email: formData.consultor_email || null,
